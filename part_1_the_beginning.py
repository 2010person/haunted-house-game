...
try:
    house = [["entrance_room", "The entrance room is damp, smells of wet wood, with a singular candle hung in the far corner.", True, False], # Defining the rooms, the description, whether it is lit, and whether it is locked 
            ["living_room", "Is that a fossilised sofa, wow the cobwebs have created intricate designs!", False, True],
            "kitchen", "parlour", "dining hall", "cellar"] 
    ...
    def level_0():
        global house, puzzles, items # Allowing the function to access the global variables
        print(house[0][1])
        print(puzzles[0])
        house[1][3] = False
        while 0==0:
    ...
    1 - Wait in the darkness for something to come and kill us""")
            ...
            print(pass) # Description for the living room
            while 0==0:
                option = input("""Please choose where the message is located, it was in a place where his hatred burned.
